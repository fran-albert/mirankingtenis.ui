        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-gray-500 dark:text-gray-400 mb-1">Ganados</p>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-gray-500 dark:text-gray-400 mb-1">Títulos</p>
                <p className="font-medium">20</p>
              </div>
              <div>
                <p className="text-gray-500 dark:text-gray-400 mb-1">Finales</p>
